...
.. include-file:: sections/Include/Comms_XMLpath.rstinc "" ".. _ref-IEC61850clXMLpath:"
   ...
   * :attr:     .. _ref-IEC61850clCIDpath:
     ...
     :desc:     IED CID or SCD file name and path. This file contains communication capabilites and settings of the IED.
		...
		File path may be omitted if XML file is stored in the same directory as leandc firmware (/home/leandc/app by default)
   ...
   * :attr:     .. _ref-IEC61850clIEDname:
                ...
                :xmlref:`IEDname`
     :val:      Max 64 chars
     :desc:     IED name as specified in the CID/SCD file.
		:xmlref:`IEDname` must be specified if CID/SCD file contains more than one IED.
